...
`[Insert specific purposes of protecting community’s trademarks. For example: “When readers see the puzzle globe mark in the top left corner of a website that looks like Wikipedia, they should be confident that they are looking at neutral, notable, and high quality content that is the result of the rigorous and transparent editing process on Wikipedia.”]` 
